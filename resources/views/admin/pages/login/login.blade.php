...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{ asset('assets/global/plugins/iCheck/square/blue.css') }}">
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>RSU</b>ONLINE EVALUATION</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Sign in to start your session</p>

    <form action="{{ url('admin/login/post-login') }}" method="POST">
      {!! csrf_field() !!}
